...
export default function BloomsPage() {
  ...
  return <main className="blooms-page" id="blooms-top">
    ...
    <footer className="blooms-footer"><p>Good books.<br /><em>Brighter days.</em></p><div><a href={`${import.meta.env.BASE_URL}#work`}>↖ Explore selected work</a><a href="#blooms-top">Back to top ↑</a></div><span>Blooms / Independent redesign concept / 2026</span></footer>
  </main>
}
